...
#define bwb_rint                         X001A8
#define bwb_scan                         X001A9
#define bwb_strcat                       X001AA
#define bwb_strchr                       X001AB
#define bwb_strcmp                       X001AC
#define bwb_strcpy                       X001AD
#define bwb_strdup                       X001AE
#define bwb_strdup2                      X001AF
#define bwb_stricmp                      X001B0
#define bwb_strlen                       X001B1
#define bwb_strncat                      X001B2
#define bwb_strncmp                      X001B3
#define bwb_strncpy                      X001B4
#define bwb_strnicmp                     X001B5
#define bwb_strrchr                      X001B6
#define bwb_tolower                      X001B7
#define bwb_toupper                      X001B8
#define bwb_vector                       X001B9
#define bwb_vertable                     X001BA
#define bwb_xnew                         X001BB
#define bwx_CLS                          X001BC
#define bwx_COLOR                        X001BD
#define bwx_Error                        X001BE
#define bwx_LOCATE                       X001BF
#define bwx_STOP                         X001C0
#define bwx_TIMER                        X001C1
#define bwx_input                        X001C2
#define bwx_terminate                    X001C3
#define clear_virtual_by_file            X001C4
#define field_close_file                 X001C5
#define field_free_variable              X001C6
#define field_get                        X001C7
#define field_put                        X001C8
#define file_clear                       X001C9
#define file_new                         X001CA
#define file_next_number                 X001CB
#define find_file_by_name                X001CC
#define find_file_by_number              X001CD
#define find_line_number                 X001CE
#define is_empty_string                  X001CF
#define line_is_eol                      X001D0
#define line_peek_EqualChar              X001D1
#define line_peek_LparenChar             X001D2
#define line_peek_QuoteChar              X001D3
#define line_peek_array_dimensions       X001D4
#define line_peek_char                   X001D5
#define line_peek_word                   X001D6
#define line_read_array_dimensions       X001D7
#define line_read_array_redim            X001D8
#define line_read_expression             X001D9
#define line_read_index_item             X001DA
#define line_read_integer_expression     X001DB
#define line_read_label                  X001DC
#define line_read_letter_sequence        X001DD
#define line_read_line_number            X001DE
#define line_read_line_sequence          X001DF
#define line_read_matrix                 X001E0
#define line_read_numeric_expression     X001E1
#define line_read_scalar                 X001E2
#define line_read_string_expression      X001E3
#define line_read_type_declaration       X001E4
#define line_read_varname                X001E5
#define line_skip_AtChar                 X001E6
#define line_skip_CommaChar              X001E7
#define line_skip_EqualChar              X001E8
#define line_skip_FilenumChar            X001E9
#define line_skip_LparenChar             X001EA
#define line_skip_MinusChar              X001EB
#define line_skip_PlusChar               X001EC
#define line_skip_RparenChar             X001ED
#define line_skip_SemicolonChar          X001EE
#define line_skip_StarChar               X001EF
#define line_skip_char                   X001F0
#define line_skip_eol                    X001F1
#define line_skip_seperator              X001F2
#define line_skip_spaces                 X001F3
#define line_skip_word                   X001F4
#define line_start                       X001F5
#define mat_find                         X001F6
#define str_btob                         X001F7
#define str_cmp                          X001F8
#define str_match                        X001F9
#define var_CLEAR                        X001FA
#define var_chain                        X001FB
#define var_delcvars                     X001FC
#define var_find                         X001FD
#define var_free                         X001FE
#define var_get                          X001FF
#define var_init                         X00200
#define var_make                         X00201
#define var_nametype                     X00202
#define var_new                          X00203
#define var_set                          X00204
